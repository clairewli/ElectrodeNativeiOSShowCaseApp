...
class MoreViewController: ERNBaseViewController {
...
//    }()
    ...
    func retrieveView() {
        let miniAppViewController = ElectrodeReactNative.sharedInstance().miniApp(withName: "NavDemoMiniApp", properties: nil)
